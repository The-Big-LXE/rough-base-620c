...
```
npm create cloudflare@latest -- --template=cloudflare/templates/rough-base-620c
```

A live public deployment of this template is available at [https://rough-base-620c.templates.workers.dev](https://rough-base-620c.templates.workers.dev)
